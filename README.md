...
Each image is scanned using ```getmeta``` to extract system file metadata. The resulting artifacts are normalized, hashed with BLAKE3, and published as Parquet datasets for downstream analysis and bloom filter generation.
